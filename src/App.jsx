  ...
  return (
    ...
    <div className='main d-flex'>
     ...
     <Route element={<ProtectedRoute/>}> 
         ...
         <Route path="/medical/medical_detail/:medical_id" element={<ViewMedicalPage />} />   
         <Route path='/clinic'  element={<Clinic/>}/>
         <Route path='/login'  element={<Login/>}/>
         <Route path='/admin'  element={<Admin/>}/>
         <Route path='/doctor'  element={<DoctorDashboard/>}/>
         <Route path="/doctor/doctor_detail/:doctor_id" element={<ViewDoctorPage />} />   
          <Route path="/edit_doctor_profile/:doctor_id" element={<EditDoctorPage />} />  
         <Route path='/patient'  element={<Patient/>}/>
         <Route path='/patient/patient_detail'  element={<ViewPatientPage/>}/>
         <Route path='/appointment'  element={<Appointment/>}/>
         <Route path='/instant_call'  element={<InstantCall/>}/>
         <Route path='/payment_table'  element={<PaymentTable/>}/>
         <Route path='/prescription_table'  element={<PrescriptionTable/>}/>
